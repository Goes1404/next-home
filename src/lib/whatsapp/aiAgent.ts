...
export const PROMPT_VERSAO = "2026.09-v28"; // a Sofia passa a dar o PISO ("a partir de R$ X", copiado da ficha e validado contra o catálogo): sem jogada nenhuma contra quem insiste em preço, `avancou` ficou 0 em todas as personas da v25 à v27
