    ...
    <section id="contato" className="scroll-mt-24 bg-ink-900/40 px-4 py-16 sm:py-24">
      <Reveal className="mx-auto max-w-xl text-center">
        ...
        <p className="text-fluid-base mt-3 text-mist-300">
          Fale direto com quem acompanha o {e.nome} de perto.
        </p>
        ...
        <div className="mt-8 rounded-2xl border border-white/10 bg-ink-900 px-6 py-7">
          ...
          <a
            ...
            className="mt-6 flex w-full items-center justify-center gap-2 rounded-full bg-brand-500 px-7 py-3.5 text-sm font-medium text-white transition-colors hover:bg-brand-400"
          >
