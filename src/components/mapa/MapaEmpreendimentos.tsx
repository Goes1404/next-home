...
const MapaClient = dynamic(() => import("./MapaInterativoClient"), {
  ssr: false,
  loading: () => (
    <div className="w-full h-[calc(100vh-80px)] min-h-[500px] rounded-2xl border border-white/10 bg-ink-950/80 flex flex-col items-center justify-center gap-3 backdrop-blur-xl animate-pulse">
      ...
      <p className="text-fluid-sm text-mist-300 font-medium tracking-wide">
