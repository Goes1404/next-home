  ...
  return (
    <FlutuanteVisivel>
      <WhatsappLink
        ...
        className="bg-brand-500 hover:bg-brand-400 active:bg-brand-600 relative flex size-14 items-center justify-center rounded-full text-white shadow-[0_12px_32px_-10px_rgb(0_0_0/0.65)] ring-1 ring-white/25 transition-[background-color,transform] duration-200 active:scale-95 motion-reduce:transition-none"
      >
        {/* Anel que pulsa a cada 6s: chama o olho para a conversão sem
            competir com o conteúdo (é a exceção declarada da régua de
            movimento em repouso). Motion-safe: some para quem pediu menos
            movimento. */}
        <span
          aria-hidden
          className="bg-brand-400 pointer-events-none absolute inset-0 -z-10 rounded-full motion-safe:anel-pulso"
        />
