    ...
    <div className="pb-safe fixed right-4 bottom-4 z-40 sm:bottom-6">
      <GlassSurface preset="pill" tint={0.2} intensity={1.2}>
        <WhatsappLink
          ...
          aria-label={rotulo}
          title={rotulo}
          className="flex h-14 w-14 items-center justify-center text-titulo"
        >
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className="h-7 w-7 text-acento-suave">
